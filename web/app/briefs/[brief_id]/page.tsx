...
export default async function BriefDetailPage({
  ...
  const isViewingDraft = viewingVersion !== null && viewingVersion === baseBrief.unsent_version;
  const updateVersion = isViewingDraft ? brief.version : baseBrief.unsent_version;
