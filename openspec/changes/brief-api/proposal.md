...
- 实现 `/briefs/:brief_id/editing?action=patch|submit-review`：编辑阶段内容修改和提交审查。
...
- `brief-crud`: Brief 的创建、列表查询、详情获取（含 `unfinalized_version`）、editing 阶段 patch/submit-review。
